import{b as Ce,p as A,E,a as l,n as _e,d as P,l as N,L as B}from"./assets/index-CtnQ7lw9.js";import{C as Se}from"./assets/constants-4DKqSpZt.js";const Pe=window.self===window.top;function ve(t){if(!Pe){Ce.debug("Skipping iframe context");return}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t):t()}const we=`
		:host {
			all: initial;
			position: fixed;
