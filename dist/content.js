import{b as nr,p as ae,E as T,a as d,l as k,L as I,n as gt,d as re}from"./assets/index-CtnQ7lw9.js";import{u as oe}from"./assets/store-SF67hG8t.js";import{S as rr}from"./assets/chromeStorage-BOBytA-p.js";import{C as or}from"./assets/constants-DOucEiR9.js";const ir=window.self===window.top;function sr(t){if(!ir){nr.debug("Skipping iframe context");return}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t):t()}const en="picsel-toggle-host",ht="picsel-toggle-panel",cr={coupang:"쿠팡",amazon:"아마존",ebay:"이베이",gmarket:"G마켓","11st":"11번가",naver:"네이버쇼핑",tmon:"티몬",wemakeprice:"위메프"},ar=t=>{if(!t)return"PicSel";const e=String(t).toLowerCase();return cr[e]||String(t)},f={hostElement:null,shadowRoot:null,toggleButton:null,buttonLabelEl:null,buttonBadgeEl:null,panelEl:null,closeButtonEl:null,contentEl:null,panelTitleEl:null,mounted:!1,cachedData:null,comparison:{status:"idle",query:null,error:null,data:null}},fe=(t,e="KRW")=>{if(typeof t!="number"||!Number.isFinite(t))return null;const n=e||"KRW",r=new Set(["KRW","JPY"]),o={style:"currency",currency:n};let i=t;r.has(n)&&(o.minimumFractionDigits=0,o.maximumFractionDigits=0,i=Math.round(t));const c=n==="KRW"?"ko-KR":"en-US";return new Intl.NumberFormat(c,o).format(i)},lr=(t,e)=>typeof t!="number"||typeof e!="number"||t<=0||e>=t?null:Math.round((t-e)/t*100),ur=t=>{const e=document.createElement("div");e.className="picsel-product";const n=document.createElement("div");n.className="picsel-product-thumb";const r=t.imageUrl||Array.isArray(t.images)&&t.images[0]||null;if(r){const p=document.createElement("img");p.src=r,p.alt=t.title?`${t.title} 이미지`:"상품 이미지",n.appendChild(p)}else{const p=document.createElement("span");p.textContent="No Image",p.style.fontSize="11px",p.style.color="#64748b",n.appendChild(p)}const o=document.createElement("div");o.className="picsel-product-info";const i=document.createElement("h3");i.className="picsel-product-title",i.textContent=t.title||"상품 정보를 찾을 수 없어요.";const c=document.createElement("div");c.className="picsel-price";const s=typeof t.discountPrice=="number"&&t.discountPrice>0?t.discountPrice:t.amount,l=fe(s,t.currency??"KRW");if(l){const p=document.createElement("div");p.className="picsel-final-price",p.textContent=l,c.appendChild(p)}const u=fe(t.originalPrice,t.currency??"KRW"),m=lr(t.originalPrice,s);if(u&&m){const p=document.createElement("div");p.className="picsel-original-price",p.textContent=u;const b=document.createElement("div");b.className="picsel-discount-tag",b.textContent=`-${m}%`,c.appendChild(p),c.appendChild(b)}if(o.appendChild(i),o.appendChild(c),t.shippingInfo){const p=document.createElement("div");p.className="picsel-shipping",p.textContent=`배송: ${t.shippingInfo}`,o.appendChild(p)}return e.appendChild(n),e.appendChild(o),e};const{entries:En,setPrototypeOf:tn,isFrozen:dr,getPrototypeOf:pr,getOwnPropertyDescriptor:fr}=Object;let{freeze:H,seal:Z,create:At}=Object,{apply:Tt,construct:vt}=typeof Reflect<"u"&&Reflect;H||(H=function(e){return e});Z||(Z=function(e){return e});Tt||(Tt=function(e,n){for(var r=arguments.length,o=new Array(r>2?r-2:0),i=2;i<r;i++)o[i-2]=arguments[i];return e.apply(n,o)});vt||(vt=function(e){for(var n=arguments.length,r=new Array(n>1?n-1:0),o=1;o<n;o++)r[o-1]=arguments[o];return new e(...r)});const Ke=G(Array.prototype.forEach),mr=G(Array.prototype.lastIndexOf),nn=G(Array.prototype.pop),Ie=G(Array.prototype.push),gr=G(Array.prototype.splice),Ve=G(String.prototype.toLowerCase),xt=G(String.prototype.toString),bt=G(String.prototype.match),Re=G(String.prototype.replace),hr=G(String.prototype.indexOf),xr=G(String.prototype.trim),Q=G(Object.prototype.hasOwnProperty),W=G(RegExp.prototype.test),De=br(TypeError);function G(t){return function(e){e instanceof RegExp&&(e.lastIndex=0);for(var n=arguments.length,r=new Array(n>1?n-1:0),o=1;o<n;o++)r[o-1]=arguments[o];return Tt(t,e,r)}}function br(t){return function(){for(var e=arguments.length,n=new Array(e),r=0;r<e;r++)n[r]=arguments[r];return vt(t,n)}}function S(t,e){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Ve;tn&&tn(t,null);let r=e.length;for(;r--;){let o=e[r];if(typeof o=="string"){const i=n(o);i!==o&&(dr(e)||(e[r]=i),o=i)}t[o]=!0}return t}function Er(t){for(let e=0;e<t.length;e++)Q(t,e)||(t[e]=null);return t}function ne(t){const e=At(null);for(const[n,r]of En(t))Q(t,n)&&(Array.isArray(r)?e[n]=Er(r):r&&typeof r=="object"&&r.constructor===Object?e[n]=ne(r):e[n]=r);return e}function Oe(t,e){for(;t!==null;){const r=fr(t,e);if(r){if(r.get)return G(r.get);if(typeof r.value=="function")return G(r.value)}t=pr(t)}function n(){return null}return n}const rn=H(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Et=H(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),yt=H(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),yr=H(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),_t=H(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),_r=H(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),on=H(["#text"]),sn=H(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),Ct=H(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),cn=H(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),je=H(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Cr=Z(/\{\{[\w\W]*|[\w\W]*\}\}/gm),Sr=Z(/<%[\w\W]*|[\w\W]*%>/gm),Ar=Z(/\$\{[\w\W]*/gm),Tr=Z(/^data-[\-\w.\u00B7-\uFFFF]+$/),vr=Z(/^aria-[\-\w]+$/),yn=Z(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),wr=Z(/^(?:\w+script|data):/i),Pr=Z(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),_n=Z(/^html$/i),Nr=Z(/^[a-z][.\w]*(-[.\w]+)+$/i);var an=Object.freeze({__proto__:null,ARIA_ATTR:vr,ATTR_WHITESPACE:Pr,CUSTOM_ELEMENT:Nr,DATA_ATTR:Tr,DOCTYPE_NAME:_n,ERB_EXPR:Sr,IS_ALLOWED_URI:yn,IS_SCRIPT_OR_DATA:wr,MUSTACHE_EXPR:Cr,TMPLIT_EXPR:Ar});const Le={element:1,text:3,progressingInstruction:7,comment:8,document:9},kr=function(){return typeof window>"u"?null:window},Ir=function(e,n){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let r=null;const o="data-tt-policy-suffix";n&&n.hasAttribute(o)&&(r=n.getAttribute(o));const i="dompurify"+(r?"#"+r:"");try{return e.createPolicy(i,{createHTML(c){return c},createScriptURL(c){return c}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},ln=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Cn(){let t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:kr();const e=y=>Cn(y);if(e.version="3.3.1",e.removed=[],!t||!t.document||t.document.nodeType!==Le.document||!t.Element)return e.isSupported=!1,e;let{document:n}=t;const r=n,o=r.currentScript,{DocumentFragment:i,HTMLTemplateElement:c,Node:s,Element:l,NodeFilter:u,NamedNodeMap:m=t.NamedNodeMap||t.MozNamedAttrMap,HTMLFormElement:p,DOMParser:b,trustedTypes:g}=t,h=l.prototype,_=Oe(h,"cloneNode"),C=Oe(h,"remove"),v=Oe(h,"nextSibling"),O=Oe(h,"childNodes"),$=Oe(h,"parentNode");if(typeof c=="function"){const y=n.createElement("template");y.content&&y.content.ownerDocument&&(n=y.content.ownerDocument)}let A,X="";const{implementation:K,createNodeIterator:le,createDocumentFragment:Te,getElementsByTagName:ve}=n,{importNode:we}=r;let F=ln();e.isSupported=typeof En=="function"&&typeof $=="function"&&K&&K.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:et,ERB_EXPR:tt,TMPLIT_EXPR:nt,DATA_ATTR:Hn,ARIA_ATTR:Gn,IS_SCRIPT_OR_DATA:Kn,ATTR_WHITESPACE:kt,CUSTOM_ELEMENT:jn}=an;let{IS_ALLOWED_URI:It}=an,L=null;const Rt=S({},[...rn,...Et,...yt,..._t,...on]);let B=null;const Dt=S({},[...sn,...Ct,...cn,...je]);let N=Object.seal(At(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),Pe=null,rt=null;const me=Object.seal(At(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Ot=!0,ot=!0,Lt=!1,Mt=!0,ge=!1,ze=!0,ue=!1,it=!1,st=!1,he=!1,qe=!1,$e=!1,Bt=!0,Ut=!1;const Vn="user-content-";let ct=!0,Ne=!1,xe={},ee=null;const at=S({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let zt=null;const qt=S({},["audio","video","img","source","image","track"]);let lt=null;const $t=S({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Fe="http://www.w3.org/1998/Math/MathML",We="http://www.w3.org/2000/svg",ie="http://www.w3.org/1999/xhtml";let be=ie,ut=!1,dt=null;const Yn=S({},[Fe,We,ie],xt);let He=S({},["mi","mo","mn","ms","mtext"]),Ge=S({},["annotation-xml"]);const Xn=S({},["title","style","font","a","script"]);let ke=null;const Zn=["application/xhtml+xml","text/html"],Jn="text/html";let D=null,Ee=null;const Qn=n.createElement("form"),Ft=function(a){return a instanceof RegExp||a instanceof Function},pt=function(){let a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(Ee&&Ee===a)){if((!a||typeof a!="object")&&(a={}),a=ne(a),ke=Zn.indexOf(a.PARSER_MEDIA_TYPE)===-1?Jn:a.PARSER_MEDIA_TYPE,D=ke==="application/xhtml+xml"?xt:Ve,L=Q(a,"ALLOWED_TAGS")?S({},a.ALLOWED_TAGS,D):Rt,B=Q(a,"ALLOWED_ATTR")?S({},a.ALLOWED_ATTR,D):Dt,dt=Q(a,"ALLOWED_NAMESPACES")?S({},a.ALLOWED_NAMESPACES,xt):Yn,lt=Q(a,"ADD_URI_SAFE_ATTR")?S(ne($t),a.ADD_URI_SAFE_ATTR,D):$t,zt=Q(a,"ADD_DATA_URI_TAGS")?S(ne(qt),a.ADD_DATA_URI_TAGS,D):qt,ee=Q(a,"FORBID_CONTENTS")?S({},a.FORBID_CONTENTS,D):at,Pe=Q(a,"FORBID_TAGS")?S({},a.FORBID_TAGS,D):ne({}),rt=Q(a,"FORBID_ATTR")?S({},a.FORBID_ATTR,D):ne({}),xe=Q(a,"USE_PROFILES")?a.USE_PROFILES:!1,Ot=a.ALLOW_ARIA_ATTR!==!1,ot=a.ALLOW_DATA_ATTR!==!1,Lt=a.ALLOW_UNKNOWN_PROTOCOLS||!1,Mt=a.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ge=a.SAFE_FOR_TEMPLATES||!1,ze=a.SAFE_FOR_XML!==!1,ue=a.WHOLE_DOCUMENT||!1,he=a.RETURN_DOM||!1,qe=a.RETURN_DOM_FRAGMENT||!1,$e=a.RETURN_TRUSTED_TYPE||!1,st=a.FORCE_BODY||!1,Bt=a.SANITIZE_DOM!==!1,Ut=a.SANITIZE_NAMED_PROPS||!1,ct=a.KEEP_CONTENT!==!1,Ne=a.IN_PLACE||!1,It=a.ALLOWED_URI_REGEXP||yn,be=a.NAMESPACE||ie,He=a.MATHML_TEXT_INTEGRATION_POINTS||He,Ge=a.HTML_INTEGRATION_POINTS||Ge,N=a.CUSTOM_ELEMENT_HANDLING||{},a.CUSTOM_ELEMENT_HANDLING&&Ft(a.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(N.tagNameCheck=a.CUSTOM_ELEMENT_HANDLING.tagNameCheck),a.CUSTOM_ELEMENT_HANDLING&&Ft(a.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(N.attributeNameCheck=a.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),a.CUSTOM_ELEMENT_HANDLING&&typeof a.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(N.allowCustomizedBuiltInElements=a.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),ge&&(ot=!1),qe&&(he=!0),xe&&(L=S({},on),B=[],xe.html===!0&&(S(L,rn),S(B,sn)),xe.svg===!0&&(S(L,Et),S(B,Ct),S(B,je)),xe.svgFilters===!0&&(S(L,yt),S(B,Ct),S(B,je)),xe.mathMl===!0&&(S(L,_t),S(B,cn),S(B,je))),a.ADD_TAGS&&(typeof a.ADD_TAGS=="function"?me.tagCheck=a.ADD_TAGS:(L===Rt&&(L=ne(L)),S(L,a.ADD_TAGS,D))),a.ADD_ATTR&&(typeof a.ADD_ATTR=="function"?me.attributeCheck=a.ADD_ATTR:(B===Dt&&(B=ne(B)),S(B,a.ADD_ATTR,D))),a.ADD_URI_SAFE_ATTR&&S(lt,a.ADD_URI_SAFE_ATTR,D),a.FORBID_CONTENTS&&(ee===at&&(ee=ne(ee)),S(ee,a.FORBID_CONTENTS,D)),a.ADD_FORBID_CONTENTS&&(ee===at&&(ee=ne(ee)),S(ee,a.ADD_FORBID_CONTENTS,D)),ct&&(L["#text"]=!0),ue&&S(L,["html","head","body"]),L.table&&(S(L,["tbody"]),delete Pe.tbody),a.TRUSTED_TYPES_POLICY){if(typeof a.TRUSTED_TYPES_POLICY.createHTML!="function")throw De('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof a.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw De('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');A=a.TRUSTED_TYPES_POLICY,X=A.createHTML("")}else A===void 0&&(A=Ir(g,o)),A!==null&&typeof X=="string"&&(X=A.createHTML(""));H&&H(a),Ee=a}},Wt=S({},[...Et,...yt,...yr]),Ht=S({},[..._t,..._r]),er=function(a){let x=$(a);(!x||!x.tagName)&&(x={namespaceURI:be,tagName:"template"});const E=Ve(a.tagName),P=Ve(x.tagName);return dt[a.namespaceURI]?a.namespaceURI===We?x.namespaceURI===ie?E==="svg":x.namespaceURI===Fe?E==="svg"&&(P==="annotation-xml"||He[P]):!!Wt[E]:a.namespaceURI===Fe?x.namespaceURI===ie?E==="math":x.namespaceURI===We?E==="math"&&Ge[P]:!!Ht[E]:a.namespaceURI===ie?x.namespaceURI===We&&!Ge[P]||x.namespaceURI===Fe&&!He[P]?!1:!Ht[E]&&(Xn[E]||!Wt[E]):!!(ke==="application/xhtml+xml"&&dt[a.namespaceURI]):!1},te=function(a){Ie(e.removed,{element:a});try{$(a).removeChild(a)}catch{C(a)}},de=function(a,x){try{Ie(e.removed,{attribute:x.getAttributeNode(a),from:x})}catch{Ie(e.removed,{attribute:null,from:x})}if(x.removeAttribute(a),a==="is")if(he||qe)try{te(x)}catch{}else try{x.setAttribute(a,"")}catch{}},Gt=function(a){let x=null,E=null;if(st)a="<remove></remove>"+a;else{const R=bt(a,/^[\r\n\t ]+/);E=R&&R[0]}ke==="application/xhtml+xml"&&be===ie&&(a='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+a+"</body></html>");const P=A?A.createHTML(a):a;if(be===ie)try{x=new b().parseFromString(P,ke)}catch{}if(!x||!x.documentElement){x=K.createDocument(be,"template",null);try{x.documentElement.innerHTML=ut?X:P}catch{}}const q=x.body||x.documentElement;return a&&E&&q.insertBefore(n.createTextNode(E),q.childNodes[0]||null),be===ie?ve.call(x,ue?"html":"body")[0]:ue?x.documentElement:q},Kt=function(a){return le.call(a.ownerDocument||a,a,u.SHOW_ELEMENT|u.SHOW_COMMENT|u.SHOW_TEXT|u.SHOW_PROCESSING_INSTRUCTION|u.SHOW_CDATA_SECTION,null)},ft=function(a){return a instanceof p&&(typeof a.nodeName!="string"||typeof a.textContent!="string"||typeof a.removeChild!="function"||!(a.attributes instanceof m)||typeof a.removeAttribute!="function"||typeof a.setAttribute!="function"||typeof a.namespaceURI!="string"||typeof a.insertBefore!="function"||typeof a.hasChildNodes!="function")},jt=function(a){return typeof s=="function"&&a instanceof s};function se(y,a,x){Ke(y,E=>{E.call(e,a,x,Ee)})}const Vt=function(a){let x=null;if(se(F.beforeSanitizeElements,a,null),ft(a))return te(a),!0;const E=D(a.nodeName);if(se(F.uponSanitizeElement,a,{tagName:E,allowedTags:L}),ze&&a.hasChildNodes()&&!jt(a.firstElementChild)&&W(/<[/\w!]/g,a.innerHTML)&&W(/<[/\w!]/g,a.textContent)||a.nodeType===Le.progressingInstruction||ze&&a.nodeType===Le.comment&&W(/<[/\w]/g,a.data))return te(a),!0;if(!(me.tagCheck instanceof Function&&me.tagCheck(E))&&(!L[E]||Pe[E])){if(!Pe[E]&&Xt(E)&&(N.tagNameCheck instanceof RegExp&&W(N.tagNameCheck,E)||N.tagNameCheck instanceof Function&&N.tagNameCheck(E)))return!1;if(ct&&!ee[E]){const P=$(a)||a.parentNode,q=O(a)||a.childNodes;if(q&&P){const R=q.length;for(let j=R-1;j>=0;--j){const ce=_(q[j],!0);ce.__removalCount=(a.__removalCount||0)+1,P.insertBefore(ce,v(a))}}}return te(a),!0}return a instanceof l&&!er(a)||(E==="noscript"||E==="noembed"||E==="noframes")&&W(/<\/no(script|embed|frames)/i,a.innerHTML)?(te(a),!0):(ge&&a.nodeType===Le.text&&(x=a.textContent,Ke([et,tt,nt],P=>{x=Re(x,P," ")}),a.textContent!==x&&(Ie(e.removed,{element:a.cloneNode()}),a.textContent=x)),se(F.afterSanitizeElements,a,null),!1)},Yt=function(a,x,E){if(Bt&&(x==="id"||x==="name")&&(E in n||E in Qn))return!1;if(!(ot&&!rt[x]&&W(Hn,x))){if(!(Ot&&W(Gn,x))){if(!(me.attributeCheck instanceof Function&&me.attributeCheck(x,a))){if(!B[x]||rt[x]){if(!(Xt(a)&&(N.tagNameCheck instanceof RegExp&&W(N.tagNameCheck,a)||N.tagNameCheck instanceof Function&&N.tagNameCheck(a))&&(N.attributeNameCheck instanceof RegExp&&W(N.attributeNameCheck,x)||N.attributeNameCheck instanceof Function&&N.attributeNameCheck(x,a))||x==="is"&&N.allowCustomizedBuiltInElements&&(N.tagNameCheck instanceof RegExp&&W(N.tagNameCheck,E)||N.tagNameCheck instanceof Function&&N.tagNameCheck(E))))return!1}else if(!lt[x]){if(!W(It,Re(E,kt,""))){if(!((x==="src"||x==="xlink:href"||x==="href")&&a!=="script"&&hr(E,"data:")===0&&zt[a])){if(!(Lt&&!W(Kn,Re(E,kt,"")))){if(E)return!1}}}}}}}return!0},Xt=function(a){return a!=="annotation-xml"&&bt(a,jn)},Zt=function(a){se(F.beforeSanitizeAttributes,a,null);const{attributes:x}=a;if(!x||ft(a))return;const E={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:B,forceKeepAttr:void 0};let P=x.length;for(;P--;){const q=x[P],{name:R,namespaceURI:j,value:ce}=q,ye=D(R),mt=ce;let U=R==="value"?mt:xr(mt);if(E.attrName=ye,E.attrValue=U,E.keepAttr=!0,E.forceKeepAttr=void 0,se(F.uponSanitizeAttribute,a,E),U=E.attrValue,Ut&&(ye==="id"||ye==="name")&&(de(R,a),U=Vn+U),ze&&W(/((--!?|])>)|<\/(style|title|textarea)/i,U)){de(R,a);continue}if(ye==="attributename"&&bt(U,"href")){de(R,a);continue}if(E.forceKeepAttr)continue;if(!E.keepAttr){de(R,a);continue}if(!Mt&&W(/\/>/i,U)){de(R,a);continue}ge&&Ke([et,tt,nt],Qt=>{U=Re(U,Qt," ")});const Jt=D(a.nodeName);if(!Yt(Jt,ye,U)){de(R,a);continue}if(A&&typeof g=="object"&&typeof g.getAttributeType=="function"&&!j)switch(g.getAttributeType(Jt,ye)){case"TrustedHTML":{U=A.createHTML(U);break}case"TrustedScriptURL":{U=A.createScriptURL(U);break}}if(U!==mt)try{j?a.setAttributeNS(j,R,U):a.setAttribute(R,U),ft(a)?te(a):nn(e.removed)}catch{de(R,a)}}se(F.afterSanitizeAttributes,a,null)},tr=function y(a){let x=null;const E=Kt(a);for(se(F.beforeSanitizeShadowDOM,a,null);x=E.nextNode();)se(F.uponSanitizeShadowNode,x,null),Vt(x),Zt(x),x.content instanceof i&&y(x.content);se(F.afterSanitizeShadowDOM,a,null)};return e.sanitize=function(y){let a=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},x=null,E=null,P=null,q=null;if(ut=!y,ut&&(y="<!-->"),typeof y!="string"&&!jt(y))if(typeof y.toString=="function"){if(y=y.toString(),typeof y!="string")throw De("dirty is not a string, aborting")}else throw De("toString is not a function");if(!e.isSupported)return y;if(it||pt(a),e.removed=[],typeof y=="string"&&(Ne=!1),Ne){if(y.nodeName){const ce=D(y.nodeName);if(!L[ce]||Pe[ce])throw De("root node is forbidden and cannot be sanitized in-place")}}else if(y instanceof s)x=Gt("<!---->"),E=x.ownerDocument.importNode(y,!0),E.nodeType===Le.element&&E.nodeName==="BODY"||E.nodeName==="HTML"?x=E:x.appendChild(E);else{if(!he&&!ge&&!ue&&y.indexOf("<")===-1)return A&&$e?A.createHTML(y):y;if(x=Gt(y),!x)return he?null:$e?X:""}x&&st&&te(x.firstChild);const R=Kt(Ne?y:x);for(;P=R.nextNode();)Vt(P),Zt(P),P.content instanceof i&&tr(P.content);if(Ne)return y;if(he){if(qe)for(q=Te.call(x.ownerDocument);x.firstChild;)q.appendChild(x.firstChild);else q=x;return(B.shadowroot||B.shadowrootmode)&&(q=we.call(r,q,!0)),q}let j=ue?x.outerHTML:x.innerHTML;return ue&&L["!doctype"]&&x.ownerDocument&&x.ownerDocument.doctype&&x.ownerDocument.doctype.name&&W(_n,x.ownerDocument.doctype.name)&&(j="<!DOCTYPE "+x.ownerDocument.doctype.name+`>
`+j),ge&&Ke([et,tt,nt],ce=>{j=Re(j,ce," ")}),A&&$e?A.createHTML(j):j},e.setConfig=function(){let y=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};pt(y),it=!0},e.clearConfig=function(){Ee=null,it=!1},e.isValidAttribute=function(y,a,x){Ee||pt({});const E=D(y),P=D(a);return Yt(E,P,x)},e.addHook=function(y,a){typeof a=="function"&&Ie(F[y],a)},e.removeHook=function(y,a){if(a!==void 0){const x=mr(F[y],a);return x===-1?void 0:gr(F[y],x,1)[0]}return nn(F[y])},e.removeHooks=function(y){F[y]=[]},e.removeAllHooks=function(){F=ln()},e}var wt=Cn();const Rr=(t,e)=>typeof t!="number"||typeof e!="number"?null:Math.round(t*(e/100)),Dr=(t,e)=>typeof t!="number"||e===null?null:t-e,un=t=>{const e=t.toUpperCase(),n={KB:"KB",NH:"NH",BC:"BC"};for(const[o,i]of Object.entries(n))if(e.includes(o))return i;const r={삼성:"SS",현대:"HD",신한:"SH",국민:"KB",롯데:"LT",하나:"HN",우리:"WR",농협:"NH",비씨:"BC",씨티:"CT"};for(const[o,i]of Object.entries(r))if(t.includes(o))return i;return t.replace("카드","").substring(0,2).toUpperCase()},Or=t=>{const e=t.toUpperCase(),n=[{keywords:["BC","BC카드","비씨"],svg:"bcCard.svg"},{keywords:["KB","국민","KB국민","케이비"],svg:"kbCard.svg"},{keywords:["NH","농협","NH농협"],svg:"nhCard.svg"},{keywords:["삼성","SAMSUNG","삼성카드","SAMSUNG CARD"],svg:"samsungCard.svg"},{keywords:["현대","HYUNDAI","현대카드"],svg:"hyundaiCard.svg"},{keywords:["신한","SHINHAN","신한카드"],svg:"shinhanCard.svg"},{keywords:["롯데","LOTTE","롯데카드"],svg:"lotteCard.svg"},{keywords:["하나","HANA","하나카드","SK"],svg:"hanaCard.svg"},{keywords:["우리","WOORI","우리카드"],svg:"wooriCard.svg"},{keywords:["씨티","CITI","씨티카드","CITIBANK"],svg:"citiCard.svg"},{keywords:["VISA","비자"],svg:"visaCard.svg"},{keywords:["MASTER","마스터","MASTERCARD"],svg:"masterCard.svg"},{keywords:["AMEX","아멕스","AMERICAN EXPRESS"],svg:"amexCard.svg"}];for(const{keywords:r,svg:o}of n)for(const i of r)if(e.includes(i.toUpperCase()))try{return chrome?.runtime?.getURL(`assets/card/${o}`)??null}catch{return null}return null},Lr=(t,e,n)=>{const r=" recommended",o=document.createElement("div");o.className=`picsel-card-benefit-item${r}`;const i=t.cardName||t.card||"카드",s=Or(i)||t.imageUrl;if(s){const h=document.createElement("div");h.className="picsel-card-image-wrapper";const _=document.createElement("img");_.src=s,_.alt=i,_.className="picsel-card-image",_.onerror=()=>{const C=un(i);h.textContent="";const v=document.createElement("div");v.className="picsel-card-initial",v.textContent=wt.sanitize(C,{ALLOWED_TAGS:[]}),h.appendChild(v)},h.appendChild(_),o.appendChild(h)}else{const h=un(i),_=document.createElement("div");_.className="picsel-card-image-wrapper";const C=document.createElement("div");C.className="picsel-card-initial",C.textContent=wt.sanitize(h,{ALLOWED_TAGS:[]}),_.appendChild(C),o.appendChild(_)}const l=document.createElement("div");l.className="picsel-card-info";const u=document.createElement("div");if(u.className="picsel-card-header",(t.discountAmount??0)>0){const h=document.createElement("span");h.className="picsel-recommended-badge",h.textContent=`${e+1}위`,u.appendChild(h)}const m=document.createElement("span");m.className="picsel-card-name";const p=i.includes(",")?i.split(",")[0].trim():i;if(m.textContent=p,u.appendChild(m),l.appendChild(u),t.benefit){const h=document.createElement("div");h.className="picsel-card-benefit-desc",h.textContent=t.benefit,l.appendChild(h)}o.appendChild(l);const b=document.createElement("div");if(b.className="picsel-card-amount",t.benefitType==="installment"){const h=document.createElement("div");h.className="picsel-card-installment",h.textContent=t.benefit||"무이자",b.appendChild(h)}else if(typeof t.discountAmount=="number"&&t.discountAmount>0){if(typeof t.finalPrice=="number"){const C=document.createElement("div");C.className="picsel-card-final-price";const v=fe(t.finalPrice,n);C.textContent=v,b.appendChild(C)}const h=document.createElement("div");h.className="picsel-card-discount";const _=fe(t.discountAmount,n);h.textContent=`-${_}`,b.appendChild(h)}else if(typeof t.rate=="number"&&t.rate>0){const h=document.createElement("div");h.className="picsel-card-rate",h.textContent=`${t.rate}%`,b.appendChild(h)}return o.appendChild(b),o},Mr=t=>{const e=Array.isArray(t.cardBenefits)?t.cardBenefits:[];if(e.length===0){const g=document.createElement("section");g.className="picsel-section picsel-card-section picsel-hidden",g.setAttribute("data-empty","true"),g.style.display="none";const h=document.createElement("h4");h.className="picsel-section-title",h.textContent="카드별 혜택",g.appendChild(h);const _=document.createElement("div");return _.className="picsel-empty-benefits",_.textContent="이 상품에는 카드 혜택이 없어요",g.appendChild(_),g}const n=typeof t.discountPrice=="number"&&t.discountPrice>0?t.discountPrice:t.amount,i=e.map(g=>{const h=g;if(h.benefitType==="point"||h.benefitType==="installment")return null;const _=h.rate??h.discount;let C=0,v=0;typeof _=="number"&&_>100||h.benefitType==="discount"?(C=typeof _=="number"&&_>100?_:h.discount??0,v=0):(v=typeof _=="number"&&_<=100?_:0,C=Rr(n,v)??0);const O=Dr(n,C);return{...h,cardName:h.cardName??h.card,rate:v,discountAmount:C??void 0,finalPrice:O??void 0}}).filter(g=>g!==null).sort((g,h)=>{const _=g?.discountAmount??0,C=h?.discountAmount??0;if(_!==C)return C-_;const v=g?.rate??0;return(h?.rate??0)-v})[0];if(!i)return null;const c=document.createElement("section");c.className="picsel-section picsel-card-section";const s=document.createElement("h4");s.className="picsel-section-title",s.textContent="추천 카드 혜택",c.appendChild(s);const l=document.createElement("div");l.className="picsel-card-benefit-list";const u=t.currency??"KRW",m=Lr(i,0,u);l.appendChild(m),c.appendChild(l);const p=[],b=t.elevenst?.totalPointAmount??0;if(b>0&&p.push(`최대 적립 포인트 ${b.toLocaleString()}P`),t.giftCardDiscount?.description&&p.push(t.giftCardDiscount.description),t.cashback?.description&&p.push(t.cashback.description),p.length>0){const g=document.createElement("div");g.className="picsel-sub-benefits",p.forEach(h=>{const _=document.createElement("div");_.className="picsel-sub-benefit-item";const C=h.match(/(\d{1,3}(,\d{3})*)/);if(C){const v=h.substring(0,C.index),O=C[0],$=h.substring((C.index??0)+O.length);_.innerHTML=wt.sanitize(`${v}<strong style="color: #1d4ed8; font-weight: 700;">${O}</strong>${$}`,{ALLOWED_TAGS:["strong"],ALLOWED_ATTR:["style"]})}else _.textContent=h;g.appendChild(_)}),c.appendChild(g)}return c},Br=t=>{const e=document.createElement("footer");e.className="picsel-footer";const n=document.createElement("div");n.className="picsel-footer-buttons";const r=document.createElement("button");return r.className="picsel-footer-confirm",r.textContent="확인했습니다",r.type="button",r.addEventListener("click",()=>{Ce(!1)}),n.appendChild(r),e.appendChild(n),e},dn=(t,e)=>fe(t,e??"KRW")??`${t.toLocaleString()}원`,Ur=t=>fe(t,"KRW")??`${t.toLocaleString()}원`,zr=t=>Array.isArray(t.top_prices)&&t.top_prices.length>0?t.top_prices.map(n=>({provider:n.mall||"Unknown",name:n.mall||"Unknown",price:n.price,currency:"KRW",url:n.link,free_shipping:n.free_shipping,delivery:n.delivery})).filter(n=>typeof n.price=="number"&&n.price>0).slice(0,3):(Array.isArray(t.results)?t.results:[]).filter(n=>n&&n.success&&Array.isArray(n.products)).flatMap(n=>n.products.map(r=>({provider:n.provider,name:r.name,price:r.price,currency:r.currency,url:r.url}))).filter(n=>typeof n.price=="number"&&n.price>0).sort((n,r)=>n.price-r.price).slice(0,3),pn='<svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.333 4L6.667 11.333 3.333 8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',qr=t=>{const{panelIsOpen:e,comparison:n}=t,r=document.createElement("section");if(r.className="picsel-section picsel-lowest-price-section",!e){const g=document.createElement("div");return g.className="picsel-empty-state",g.textContent="패널을 열면 최저가 비교를 시작합니다.",r.appendChild(g),r}if(n.status==="loading"){const g=document.createElement("div");return g.className="picsel-empty-state",g.textContent="가격 비교 중...",r.appendChild(g),r}if(n.status==="error"){const g=document.createElement("div");return g.className="picsel-empty-state",g.textContent=n.error||"가격 비교 중 오류가 발생했습니다.",r.appendChild(g),r}if(n.status!=="success"||!n.data){const g=document.createElement("div");return g.className="picsel-empty-state",g.textContent="상품명을 찾을 수 없어 가격 비교를 실행할 수 없습니다.",r.appendChild(g),r}const o=n.data,i=zr(o),c=i.length>0?i[0].price:null,s=typeof o.current_price=="number"?o.current_price:null,l=c&&s&&s>c?s-c:null;if(l&&l>0){const g=document.createElement("div");g.className="picsel-savings-banner";const h=document.createElement("span");h.className="picsel-savings-icon picsel-savings-icon-green",h.innerHTML=pn;const _=document.createElement("span");_.className="picsel-savings-text",_.textContent=`지금 ${Ur(l)} 더 아낄 수 있어요!`,g.appendChild(h),g.appendChild(_),r.appendChild(g)}else if(c&&s&&s<=c){const g=document.createElement("div");g.className="picsel-no-savings-banner picsel-no-savings-banner-green";const h=document.createElement("span");h.className="picsel-savings-icon picsel-savings-icon-green",h.innerHTML=pn;const _=document.createElement("span");_.className="picsel-savings-text",_.textContent=`${dn(s,"KRW")}이 최저가입니다.`,g.appendChild(h),g.appendChild(_),r.appendChild(g)}if(i.length===0){const g=document.createElement("div");return g.className="picsel-empty-state",g.textContent="검색 결과가 없습니다.",r.appendChild(g),r}const u=document.createElement("div");u.className="picsel-section-header";const m=document.createElement("span");m.className="picsel-section-title",m.textContent="최저가 추천";const p=document.createElement("span");p.className="picsel-section-note",p.textContent="배송비 포함 기준",u.appendChild(m),u.appendChild(p),r.appendChild(u);const b=document.createElement("div");if(b.className="picsel-price-list",i.forEach((g,h)=>{const _=h===0,C=document.createElement("a");C.href=g.url||"#",C.target="_blank",C.rel="noreferrer",C.className=_?"picsel-price-item picsel-price-item-top":"picsel-price-item";const v=document.createElement("div");v.className="picsel-price-item-left";const O=document.createElement("div");O.className="picsel-mall-row";const $=document.createElement("span");if($.className="picsel-mall-name",$.textContent=(g.name||g.provider||"알 수 없음").trim(),O.appendChild($),_){const le=document.createElement("span");le.className="picsel-lowest-badge",le.textContent="최저가",O.appendChild(le)}v.appendChild(O);const A=document.createElement("div");A.className="picsel-price-item-right";const X=document.createElement("span");X.className="picsel-price-value",X.textContent=dn(g.price,g.currency);const K=document.createElement("span");K.className="picsel-price-arrow",K.innerHTML='<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M6 4l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',A.appendChild(X),A.appendChild(K),C.appendChild(v),C.appendChild(A),b.appendChild(C)}),r.appendChild(b),o.link){const g=document.createElement("a");g.href=o.link,g.target="_blank",g.rel="noreferrer",g.className="picsel-footer-link",g.innerHTML='<svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M5 2h7m0 0v7m0-7L5 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg> 정확한 정보 확인하기',r.appendChild(g)}return r},Me=t=>{const{buttonBadgeEl:e}=f;if(!e)return;if(!t){e.style.display="none";return}const n=Array.isArray(t.cardBenefits)?t.cardBenefits.map(o=>{const i=o,c=i.rate??i.discount;return typeof c=="number"?c:0}).filter(o=>o>0):[];if(n.length>0){const o=Math.max(...n);e.textContent=`최대 ${o}%`,e.style.display="inline-flex";return}const r=t.cashback?.amount;if(typeof r=="number"&&r>0){const o=fe(r,t.currency??"KRW");e.textContent=o?`${o} 적립`:"캐시백 혜택",e.style.display="inline-flex";return}e.style.display="none"},Y=()=>{const{contentEl:t,cachedData:e,panelEl:n,buttonLabelEl:r}=f;if(!t)return;if(t.textContent="",!e){const u=document.createElement("p");u.className="picsel-empty-state",u.textContent="상품 정보를 불러오는 중입니다.",t.appendChild(u),Me(null);return}const o=e,{displayMode:i}=oe.getState(),c=!!n?.classList.contains("open");if(t.appendChild(ur(o)),i==="lowest-price"){if(t.appendChild(qr({panelIsOpen:c,comparison:f.comparison})),f.comparison.status==="success"&&f.comparison.data){const u=f.comparison.data.lowest_price;typeof u=="number"&&u>0?Me({...o,cardBenefits:[{card:"최저가",benefit:`${u.toLocaleString()}원`,discount:0}]}):Me(null)}else Me(null);return}r&&!c&&(r.textContent="PicSel 혜택 보기");const s=Mr(o);s&&t.appendChild(s);const l=Br();l&&t.appendChild(l),Me(o)},$r=async(t,e,n)=>{if(t&&f.comparison.status!=="loading"&&!(f.comparison.query===t&&(f.comparison.status==="success"||f.comparison.status==="error"))){f.comparison={status:"loading",query:t,error:null,data:null};try{if(!chrome?.runtime?.sendMessage){f.comparison={status:"error",query:t,error:"Chrome extension API를 사용할 수 없습니다.",data:null},e?.();return}const r=await chrome.runtime.sendMessage({type:"CHECK_COMPARISON_SERVER"});if(!r?.success){f.comparison={status:"error",query:t,error:r?.error||"가격 비교 서버가 실행 중이 아닙니다.",data:null},e?.();return}const o=await chrome.runtime.sendMessage({type:"COMPARE_PRICES",query:t,selectedOptions:n&&n.length>0?n:void 0});if(o?.success){f.comparison={status:"success",query:t,error:null,data:{...o.data,current_price:f.cachedData?.amount}},e?.();return}f.comparison={status:"error",query:t,error:o?.error||"가격 비교 검색 실패",data:null},e?.()}catch(r){f.comparison={status:"error",query:t,error:r instanceof Error?r.message:"알 수 없는 오류",data:null},e?.()}}},Sn=(t,e,n,r)=>{if(t&&f.comparison.status!=="loading"){if(f.comparison.query===t&&(f.comparison.status==="success"||f.comparison.status==="error")){n?.();return}f.comparison={status:"loading",query:t,error:null,data:null},e(),$r(t,n,r).finally(()=>{e()})}},fn=["잠깐만요, 확인 중","지금 찾고 있어요","곧 보여드릴게요","조금만 기다려요","계산 중이에요","정리하고 있어요","비교하는 중이에요","거의 다 됐어요","지금 처리 중","금방 끝나요","찾는 중이에요","잠시만요"];let Ye=0;const An=()=>{const t=fn[Ye];return Ye=(Ye+1)%fn.length,t},Fr=()=>{Ye=0};let _e=null;const Ze=()=>{const{toggleButton:t,buttonLabelEl:e,panelEl:n}=f;if(!t||!e||!n)return;const{displayMode:r}=oe.getState();if(r!=="lowest-price")return;if(n.classList.contains("open"))Tn(),e.innerHTML="",e.textContent="PicSel 혜택 닫기";else{if(e.querySelector('[data-loading-message="true"]'))return;e.innerHTML="";const c=document.createElement("div");c.className="picsel-loading-message",c.setAttribute("data-loading-message","true"),c.style.display="flex",c.style.alignItems="center",c.style.gap="8px";const s=document.createElement("div");s.className="picsel-loading-spinner";const l=document.createElement("span");l.className="picsel-loading-text",l.textContent=An(),c.appendChild(s),c.appendChild(l),e.appendChild(c),Wr(l)}},Wr=t=>{_e&&clearInterval(_e),_e=setInterval(()=>{t.textContent=An()},2e3)},Tn=()=>{_e&&(clearInterval(_e),_e=null),Fr()},Ce=t=>{const{panelEl:e,toggleButton:n,buttonLabelEl:r}=f;if(!e||!n||!r)return;const{displayMode:o}=oe.getState(),i=o==="lowest-price";if(t){e.classList.add("open"),e.setAttribute("aria-hidden","false"),n.setAttribute("aria-expanded","true"),i&&f.cachedData?.title?Sn(f.cachedData.title,Y,void 0,f.cachedData.selectedOptions):Y(),i&&Ze();return}e.classList.remove("open"),e.setAttribute("aria-hidden","true"),n.setAttribute("aria-expanded","false"),i?Ze():Y()},Hr=`
		:host {
			all: initial;
			position: fixed;
