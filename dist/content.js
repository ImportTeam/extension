import{b as er,p as ce,E as T,a as d,l as k,L as I,n as pt,d as re}from"./assets/index-CtnQ7lw9.js";import{u as ae}from"./assets/store-SF67hG8t.js";import{S as tr}from"./assets/chromeStorage-BOBytA-p.js";import{C as nr}from"./assets/constants-DOucEiR9.js";const rr=window.self===window.top;function or(t){if(!rr){er.debug("Skipping iframe context");return}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t):t()}const Jt="picsel-toggle-host",ft="picsel-toggle-panel",ir={coupang:"쿠팡",amazon:"아마존",ebay:"이베이",gmarket:"G마켓","11st":"11번가",naver:"네이버쇼핑",tmon:"티몬",wemakeprice:"위메프"},sr=t=>{if(!t)return"PicSel";const e=String(t).toLowerCase();return ir[e]||String(t)},f={hostElement:null,shadowRoot:null,toggleButton:null,buttonLabelEl:null,buttonBadgeEl:null,panelEl:null,closeButtonEl:null,contentEl:null,panelTitleEl:null,mounted:!1,cachedData:null,comparison:{status:"idle",query:null,error:null,data:null}},fe=(t,e="KRW")=>{if(typeof t!="number"||!Number.isFinite(t))return null;const n=e||"KRW",r=new Set(["KRW","JPY"]),o={style:"currency",currency:n};let i=t;r.has(n)&&(o.minimumFractionDigits=0,o.maximumFractionDigits=0,i=Math.round(t));const c=n==="KRW"?"ko-KR":"en-US";return new Intl.NumberFormat(c,o).format(i)},cr=(t,e)=>typeof t!="number"||typeof e!="number"||t<=0||e>=t?null:Math.round((t-e)/t*100),ar=t=>{const e=document.createElement("div");e.className="picsel-product";const n=document.createElement("div");n.className="picsel-product-thumb";const r=t.imageUrl||Array.isArray(t.images)&&t.images[0]||null;if(r){const p=document.createElement("img");p.src=r,p.alt=t.title?`${t.title} 이미지`:"상품 이미지",n.appendChild(p)}else{const p=document.createElement("span");p.textContent="No Image",p.style.fontSize="11px",p.style.color="#64748b",n.appendChild(p)}const o=document.createElement("div");o.className="picsel-product-info";const i=document.createElement("h3");i.className="picsel-product-title",i.textContent=t.title||"상품 정보를 찾을 수 없어요.";const c=document.createElement("div");c.className="picsel-price";const s=typeof t.discountPrice=="number"&&t.discountPrice>0?t.discountPrice:t.amount,l=fe(s,t.currency??"KRW");if(l){const p=document.createElement("div");p.className="picsel-final-price",p.textContent=l,c.appendChild(p)}const u=fe(t.originalPrice,t.currency??"KRW"),m=cr(t.originalPrice,s);if(u&&m){const p=document.createElement("div");p.className="picsel-original-price",p.textContent=u;const b=document.createElement("div");b.className="picsel-discount-tag",b.textContent=`-${m}%`,c.appendChild(p),c.appendChild(b)}if(o.appendChild(i),o.appendChild(c),t.shippingInfo){const p=document.createElement("div");p.className="picsel-shipping",p.textContent=`배송: ${t.shippingInfo}`,o.appendChild(p)}return e.appendChild(n),e.appendChild(o),e};const{entries:hn,setPrototypeOf:Qt,isFrozen:lr,getPrototypeOf:ur,getOwnPropertyDescriptor:dr}=Object;let{freeze:H,seal:Z,create:Ct}=Object,{apply:St,construct:At}=typeof Reflect<"u"&&Reflect;H||(H=function(e){return e});Z||(Z=function(e){return e});St||(St=function(e,n){for(var r=arguments.length,o=new Array(r>2?r-2:0),i=2;i<r;i++)o[i-2]=arguments[i];return e.apply(n,o)});At||(At=function(e){for(var n=arguments.length,r=new Array(n>1?n-1:0),o=1;o<n;o++)r[o-1]=arguments[o];return new e(...r)});const He=G(Array.prototype.forEach),pr=G(Array.prototype.lastIndexOf),en=G(Array.prototype.pop),ke=G(Array.prototype.push),fr=G(Array.prototype.splice),Ke=G(String.prototype.toLowerCase),mt=G(String.prototype.toString),gt=G(String.prototype.match),Ie=G(String.prototype.replace),mr=G(String.prototype.indexOf),gr=G(String.prototype.trim),Q=G(Object.prototype.hasOwnProperty),W=G(RegExp.prototype.test),Re=hr(TypeError);function G(t){return function(e){e instanceof RegExp&&(e.lastIndex=0);for(var n=arguments.length,r=new Array(n>1?n-1:0),o=1;o<n;o++)r[o-1]=arguments[o];return St(t,e,r)}}function hr(t){return function(){for(var e=arguments.length,n=new Array(e),r=0;r<e;r++)n[r]=arguments[r];return At(t,n)}}function S(t,e){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Ke;Qt&&Qt(t,null);let r=e.length;for(;r--;){let o=e[r];if(typeof o=="string"){const i=n(o);i!==o&&(lr(e)||(e[r]=i),o=i)}t[o]=!0}return t}function xr(t){for(let e=0;e<t.length;e++)Q(t,e)||(t[e]=null);return t}function ne(t){const e=Ct(null);for(const[n,r]of hn(t))Q(t,n)&&(Array.isArray(r)?e[n]=xr(r):r&&typeof r=="object"&&r.constructor===Object?e[n]=ne(r):e[n]=r);return e}function De(t,e){for(;t!==null;){const r=dr(t,e);if(r){if(r.get)return G(r.get);if(typeof r.value=="function")return G(r.value)}t=ur(t)}function n(){return null}return n}const tn=H(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),ht=H(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),xt=H(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),br=H(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),bt=H(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),yr=H(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),nn=H(["#text"]),rn=H(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),yt=H(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),on=H(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),Ge=H(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),Er=Z(/\{\{[\w\W]*|[\w\W]*\}\}/gm),_r=Z(/<%[\w\W]*|[\w\W]*%>/gm),Cr=Z(/\$\{[\w\W]*/gm),Sr=Z(/^data-[\-\w.\u00B7-\uFFFF]+$/),Ar=Z(/^aria-[\-\w]+$/),xn=Z(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),Tr=Z(/^(?:\w+script|data):/i),wr=Z(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),bn=Z(/^html$/i),vr=Z(/^[a-z][.\w]*(-[.\w]+)+$/i);var sn=Object.freeze({__proto__:null,ARIA_ATTR:Ar,ATTR_WHITESPACE:wr,CUSTOM_ELEMENT:vr,DATA_ATTR:Sr,DOCTYPE_NAME:bn,ERB_EXPR:_r,IS_ALLOWED_URI:xn,IS_SCRIPT_OR_DATA:Tr,MUSTACHE_EXPR:Er,TMPLIT_EXPR:Cr});const Le={element:1,text:3,progressingInstruction:7,comment:8,document:9},Pr=function(){return typeof window>"u"?null:window},Nr=function(e,n){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let r=null;const o="data-tt-policy-suffix";n&&n.hasAttribute(o)&&(r=n.getAttribute(o));const i="dompurify"+(r?"#"+r:"");try{return e.createPolicy(i,{createHTML(c){return c},createScriptURL(c){return c}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},cn=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function yn(){let t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Pr();const e=E=>yn(E);if(e.version="3.3.1",e.removed=[],!t||!t.document||t.document.nodeType!==Le.document||!t.Element)return e.isSupported=!1,e;let{document:n}=t;const r=n,o=r.currentScript,{DocumentFragment:i,HTMLTemplateElement:c,Node:s,Element:l,NodeFilter:u,NamedNodeMap:m=t.NamedNodeMap||t.MozNamedAttrMap,HTMLFormElement:p,DOMParser:b,trustedTypes:g}=t,x=l.prototype,_=De(x,"cloneNode"),C=De(x,"remove"),w=De(x,"nextSibling"),L=De(x,"childNodes"),q=De(x,"parentNode");if(typeof c=="function"){const E=n.createElement("template");E.content&&E.content.ownerDocument&&(n=E.content.ownerDocument)}let A,Y="";const{implementation:K,createNodeIterator:le,createDocumentFragment:Te,getElementsByTagName:we}=n,{importNode:qn}=r;let $=cn();e.isSupported=typeof hn=="function"&&typeof q=="function"&&K&&K.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:Ze,ERB_EXPR:Je,TMPLIT_EXPR:Qe,DATA_ATTR:$n,ARIA_ATTR:Wn,IS_SCRIPT_OR_DATA:Hn,ATTR_WHITESPACE:Pt,CUSTOM_ELEMENT:Gn}=sn;let{IS_ALLOWED_URI:Nt}=sn,M=null;const kt=S({},[...tn,...ht,...xt,...bt,...nn]);let B=null;const It=S({},[...rn,...yt,...on,...Ge]);let N=Object.seal(Ct(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ve=null,et=null;const me=Object.seal(Ct(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let Rt=!0,tt=!0,Dt=!1,Lt=!0,ge=!1,Be=!0,ue=!1,nt=!1,rt=!1,he=!1,Ue=!1,ze=!1,Mt=!0,Ot=!1;const Kn="user-content-";let ot=!0,Pe=!1,xe={},ee=null;const it=S({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let Bt=null;const Ut=S({},["audio","video","img","source","image","track"]);let st=null;const zt=S({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),Fe="http://www.w3.org/1998/Math/MathML",qe="http://www.w3.org/2000/svg",oe="http://www.w3.org/1999/xhtml";let be=oe,ct=!1,at=null;const jn=S({},[Fe,qe,oe],mt);let $e=S({},["mi","mo","mn","ms","mtext"]),We=S({},["annotation-xml"]);const Yn=S({},["title","style","font","a","script"]);let Ne=null;const Vn=["application/xhtml+xml","text/html"],Xn="text/html";let D=null,ye=null;const Zn=n.createElement("form"),Ft=function(a){return a instanceof RegExp||a instanceof Function},lt=function(){let a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(ye&&ye===a)){if((!a||typeof a!="object")&&(a={}),a=ne(a),Ne=Vn.indexOf(a.PARSER_MEDIA_TYPE)===-1?Xn:a.PARSER_MEDIA_TYPE,D=Ne==="application/xhtml+xml"?mt:Ke,M=Q(a,"ALLOWED_TAGS")?S({},a.ALLOWED_TAGS,D):kt,B=Q(a,"ALLOWED_ATTR")?S({},a.ALLOWED_ATTR,D):It,at=Q(a,"ALLOWED_NAMESPACES")?S({},a.ALLOWED_NAMESPACES,mt):jn,st=Q(a,"ADD_URI_SAFE_ATTR")?S(ne(zt),a.ADD_URI_SAFE_ATTR,D):zt,Bt=Q(a,"ADD_DATA_URI_TAGS")?S(ne(Ut),a.ADD_DATA_URI_TAGS,D):Ut,ee=Q(a,"FORBID_CONTENTS")?S({},a.FORBID_CONTENTS,D):it,ve=Q(a,"FORBID_TAGS")?S({},a.FORBID_TAGS,D):ne({}),et=Q(a,"FORBID_ATTR")?S({},a.FORBID_ATTR,D):ne({}),xe=Q(a,"USE_PROFILES")?a.USE_PROFILES:!1,Rt=a.ALLOW_ARIA_ATTR!==!1,tt=a.ALLOW_DATA_ATTR!==!1,Dt=a.ALLOW_UNKNOWN_PROTOCOLS||!1,Lt=a.ALLOW_SELF_CLOSE_IN_ATTR!==!1,ge=a.SAFE_FOR_TEMPLATES||!1,Be=a.SAFE_FOR_XML!==!1,ue=a.WHOLE_DOCUMENT||!1,he=a.RETURN_DOM||!1,Ue=a.RETURN_DOM_FRAGMENT||!1,ze=a.RETURN_TRUSTED_TYPE||!1,rt=a.FORCE_BODY||!1,Mt=a.SANITIZE_DOM!==!1,Ot=a.SANITIZE_NAMED_PROPS||!1,ot=a.KEEP_CONTENT!==!1,Pe=a.IN_PLACE||!1,Nt=a.ALLOWED_URI_REGEXP||xn,be=a.NAMESPACE||oe,$e=a.MATHML_TEXT_INTEGRATION_POINTS||$e,We=a.HTML_INTEGRATION_POINTS||We,N=a.CUSTOM_ELEMENT_HANDLING||{},a.CUSTOM_ELEMENT_HANDLING&&Ft(a.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(N.tagNameCheck=a.CUSTOM_ELEMENT_HANDLING.tagNameCheck),a.CUSTOM_ELEMENT_HANDLING&&Ft(a.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(N.attributeNameCheck=a.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),a.CUSTOM_ELEMENT_HANDLING&&typeof a.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(N.allowCustomizedBuiltInElements=a.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),ge&&(tt=!1),Ue&&(he=!0),xe&&(M=S({},nn),B=[],xe.html===!0&&(S(M,tn),S(B,rn)),xe.svg===!0&&(S(M,ht),S(B,yt),S(B,Ge)),xe.svgFilters===!0&&(S(M,xt),S(B,yt),S(B,Ge)),xe.mathMl===!0&&(S(M,bt),S(B,on),S(B,Ge))),a.ADD_TAGS&&(typeof a.ADD_TAGS=="function"?me.tagCheck=a.ADD_TAGS:(M===kt&&(M=ne(M)),S(M,a.ADD_TAGS,D))),a.ADD_ATTR&&(typeof a.ADD_ATTR=="function"?me.attributeCheck=a.ADD_ATTR:(B===It&&(B=ne(B)),S(B,a.ADD_ATTR,D))),a.ADD_URI_SAFE_ATTR&&S(st,a.ADD_URI_SAFE_ATTR,D),a.FORBID_CONTENTS&&(ee===it&&(ee=ne(ee)),S(ee,a.FORBID_CONTENTS,D)),a.ADD_FORBID_CONTENTS&&(ee===it&&(ee=ne(ee)),S(ee,a.ADD_FORBID_CONTENTS,D)),ot&&(M["#text"]=!0),ue&&S(M,["html","head","body"]),M.table&&(S(M,["tbody"]),delete ve.tbody),a.TRUSTED_TYPES_POLICY){if(typeof a.TRUSTED_TYPES_POLICY.createHTML!="function")throw Re('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof a.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Re('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');A=a.TRUSTED_TYPES_POLICY,Y=A.createHTML("")}else A===void 0&&(A=Nr(g,o)),A!==null&&typeof Y=="string"&&(Y=A.createHTML(""));H&&H(a),ye=a}},qt=S({},[...ht,...xt,...br]),$t=S({},[...bt,...yr]),Jn=function(a){let h=q(a);(!h||!h.tagName)&&(h={namespaceURI:be,tagName:"template"});const y=Ke(a.tagName),P=Ke(h.tagName);return at[a.namespaceURI]?a.namespaceURI===qe?h.namespaceURI===oe?y==="svg":h.namespaceURI===Fe?y==="svg"&&(P==="annotation-xml"||$e[P]):!!qt[y]:a.namespaceURI===Fe?h.namespaceURI===oe?y==="math":h.namespaceURI===qe?y==="math"&&We[P]:!!$t[y]:a.namespaceURI===oe?h.namespaceURI===qe&&!We[P]||h.namespaceURI===Fe&&!$e[P]?!1:!$t[y]&&(Yn[y]||!qt[y]):!!(Ne==="application/xhtml+xml"&&at[a.namespaceURI]):!1},te=function(a){ke(e.removed,{element:a});try{q(a).removeChild(a)}catch{C(a)}},de=function(a,h){try{ke(e.removed,{attribute:h.getAttributeNode(a),from:h})}catch{ke(e.removed,{attribute:null,from:h})}if(h.removeAttribute(a),a==="is")if(he||Ue)try{te(h)}catch{}else try{h.setAttribute(a,"")}catch{}},Wt=function(a){let h=null,y=null;if(rt)a="<remove></remove>"+a;else{const R=gt(a,/^[\r\n\t ]+/);y=R&&R[0]}Ne==="application/xhtml+xml"&&be===oe&&(a='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+a+"</body></html>");const P=A?A.createHTML(a):a;if(be===oe)try{h=new b().parseFromString(P,Ne)}catch{}if(!h||!h.documentElement){h=K.createDocument(be,"template",null);try{h.documentElement.innerHTML=ct?Y:P}catch{}}const F=h.body||h.documentElement;return a&&y&&F.insertBefore(n.createTextNode(y),F.childNodes[0]||null),be===oe?we.call(h,ue?"html":"body")[0]:ue?h.documentElement:F},Ht=function(a){return le.call(a.ownerDocument||a,a,u.SHOW_ELEMENT|u.SHOW_COMMENT|u.SHOW_TEXT|u.SHOW_PROCESSING_INSTRUCTION|u.SHOW_CDATA_SECTION,null)},ut=function(a){return a instanceof p&&(typeof a.nodeName!="string"||typeof a.textContent!="string"||typeof a.removeChild!="function"||!(a.attributes instanceof m)||typeof a.removeAttribute!="function"||typeof a.setAttribute!="function"||typeof a.namespaceURI!="string"||typeof a.insertBefore!="function"||typeof a.hasChildNodes!="function")},Gt=function(a){return typeof s=="function"&&a instanceof s};function ie(E,a,h){He(E,y=>{y.call(e,a,h,ye)})}const Kt=function(a){let h=null;if(ie($.beforeSanitizeElements,a,null),ut(a))return te(a),!0;const y=D(a.nodeName);if(ie($.uponSanitizeElement,a,{tagName:y,allowedTags:M}),Be&&a.hasChildNodes()&&!Gt(a.firstElementChild)&&W(/<[/\w!]/g,a.innerHTML)&&W(/<[/\w!]/g,a.textContent)||a.nodeType===Le.progressingInstruction||Be&&a.nodeType===Le.comment&&W(/<[/\w]/g,a.data))return te(a),!0;if(!(me.tagCheck instanceof Function&&me.tagCheck(y))&&(!M[y]||ve[y])){if(!ve[y]&&Yt(y)&&(N.tagNameCheck instanceof RegExp&&W(N.tagNameCheck,y)||N.tagNameCheck instanceof Function&&N.tagNameCheck(y)))return!1;if(ot&&!ee[y]){const P=q(a)||a.parentNode,F=L(a)||a.childNodes;if(F&&P){const R=F.length;for(let j=R-1;j>=0;--j){const se=_(F[j],!0);se.__removalCount=(a.__removalCount||0)+1,P.insertBefore(se,w(a))}}}return te(a),!0}return a instanceof l&&!Jn(a)||(y==="noscript"||y==="noembed"||y==="noframes")&&W(/<\/no(script|embed|frames)/i,a.innerHTML)?(te(a),!0):(ge&&a.nodeType===Le.text&&(h=a.textContent,He([Ze,Je,Qe],P=>{h=Ie(h,P," ")}),a.textContent!==h&&(ke(e.removed,{element:a.cloneNode()}),a.textContent=h)),ie($.afterSanitizeElements,a,null),!1)},jt=function(a,h,y){if(Mt&&(h==="id"||h==="name")&&(y in n||y in Zn))return!1;if(!(tt&&!et[h]&&W($n,h))){if(!(Rt&&W(Wn,h))){if(!(me.attributeCheck instanceof Function&&me.attributeCheck(h,a))){if(!B[h]||et[h]){if(!(Yt(a)&&(N.tagNameCheck instanceof RegExp&&W(N.tagNameCheck,a)||N.tagNameCheck instanceof Function&&N.tagNameCheck(a))&&(N.attributeNameCheck instanceof RegExp&&W(N.attributeNameCheck,h)||N.attributeNameCheck instanceof Function&&N.attributeNameCheck(h,a))||h==="is"&&N.allowCustomizedBuiltInElements&&(N.tagNameCheck instanceof RegExp&&W(N.tagNameCheck,y)||N.tagNameCheck instanceof Function&&N.tagNameCheck(y))))return!1}else if(!st[h]){if(!W(Nt,Ie(y,Pt,""))){if(!((h==="src"||h==="xlink:href"||h==="href")&&a!=="script"&&mr(y,"data:")===0&&Bt[a])){if(!(Dt&&!W(Hn,Ie(y,Pt,"")))){if(y)return!1}}}}}}}return!0},Yt=function(a){return a!=="annotation-xml"&&gt(a,Gn)},Vt=function(a){ie($.beforeSanitizeAttributes,a,null);const{attributes:h}=a;if(!h||ut(a))return;const y={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:B,forceKeepAttr:void 0};let P=h.length;for(;P--;){const F=h[P],{name:R,namespaceURI:j,value:se}=F,Ee=D(R),dt=se;let U=R==="value"?dt:gr(dt);if(y.attrName=Ee,y.attrValue=U,y.keepAttr=!0,y.forceKeepAttr=void 0,ie($.uponSanitizeAttribute,a,y),U=y.attrValue,Ot&&(Ee==="id"||Ee==="name")&&(de(R,a),U=Kn+U),Be&&W(/((--!?|])>)|<\/(style|title|textarea)/i,U)){de(R,a);continue}if(Ee==="attributename"&&gt(U,"href")){de(R,a);continue}if(y.forceKeepAttr)continue;if(!y.keepAttr){de(R,a);continue}if(!Lt&&W(/\/>/i,U)){de(R,a);continue}ge&&He([Ze,Je,Qe],Zt=>{U=Ie(U,Zt," ")});const Xt=D(a.nodeName);if(!jt(Xt,Ee,U)){de(R,a);continue}if(A&&typeof g=="object"&&typeof g.getAttributeType=="function"&&!j)switch(g.getAttributeType(Xt,Ee)){case"TrustedHTML":{U=A.createHTML(U);break}case"TrustedScriptURL":{U=A.createScriptURL(U);break}}if(U!==dt)try{j?a.setAttributeNS(j,R,U):a.setAttribute(R,U),ut(a)?te(a):en(e.removed)}catch{de(R,a)}}ie($.afterSanitizeAttributes,a,null)},Qn=function E(a){let h=null;const y=Ht(a);for(ie($.beforeSanitizeShadowDOM,a,null);h=y.nextNode();)ie($.uponSanitizeShadowNode,h,null),Kt(h),Vt(h),h.content instanceof i&&E(h.content);ie($.afterSanitizeShadowDOM,a,null)};return e.sanitize=function(E){let a=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},h=null,y=null,P=null,F=null;if(ct=!E,ct&&(E="<!-->"),typeof E!="string"&&!Gt(E))if(typeof E.toString=="function"){if(E=E.toString(),typeof E!="string")throw Re("dirty is not a string, aborting")}else throw Re("toString is not a function");if(!e.isSupported)return E;if(nt||lt(a),e.removed=[],typeof E=="string"&&(Pe=!1),Pe){if(E.nodeName){const se=D(E.nodeName);if(!M[se]||ve[se])throw Re("root node is forbidden and cannot be sanitized in-place")}}else if(E instanceof s)h=Wt("<!---->"),y=h.ownerDocument.importNode(E,!0),y.nodeType===Le.element&&y.nodeName==="BODY"||y.nodeName==="HTML"?h=y:h.appendChild(y);else{if(!he&&!ge&&!ue&&E.indexOf("<")===-1)return A&&ze?A.createHTML(E):E;if(h=Wt(E),!h)return he?null:ze?Y:""}h&&rt&&te(h.firstChild);const R=Ht(Pe?E:h);for(;P=R.nextNode();)Kt(P),Vt(P),P.content instanceof i&&Qn(P.content);if(Pe)return E;if(he){if(Ue)for(F=Te.call(h.ownerDocument);h.firstChild;)F.appendChild(h.firstChild);else F=h;return(B.shadowroot||B.shadowrootmode)&&(F=qn.call(r,F,!0)),F}let j=ue?h.outerHTML:h.innerHTML;return ue&&M["!doctype"]&&h.ownerDocument&&h.ownerDocument.doctype&&h.ownerDocument.doctype.name&&W(bn,h.ownerDocument.doctype.name)&&(j="<!DOCTYPE "+h.ownerDocument.doctype.name+`>
`+j),ge&&He([Ze,Je,Qe],se=>{j=Ie(j,se," ")}),A&&ze?A.createHTML(j):j},e.setConfig=function(){let E=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};lt(E),nt=!0},e.clearConfig=function(){ye=null,nt=!1},e.isValidAttribute=function(E,a,h){ye||lt({});const y=D(E),P=D(a);return jt(y,P,h)},e.addHook=function(E,a){typeof a=="function"&&ke($[E],a)},e.removeHook=function(E,a){if(a!==void 0){const h=pr($[E],a);return h===-1?void 0:fr($[E],h,1)[0]}return en($[E])},e.removeHooks=function(E){$[E]=[]},e.removeAllHooks=function(){$=cn()},e}var Tt=yn();const kr=(t,e)=>typeof t!="number"||typeof e!="number"?null:Math.round(t*(e/100)),Ir=(t,e)=>typeof t!="number"||e===null?null:t-e,an=t=>{const e=t.toUpperCase(),n={KB:"KB",NH:"NH",BC:"BC"};for(const[o,i]of Object.entries(n))if(e.includes(o))return i;const r={삼성:"SS",현대:"HD",신한:"SH",국민:"KB",롯데:"LT",하나:"HN",우리:"WR",농협:"NH",비씨:"BC",씨티:"CT"};for(const[o,i]of Object.entries(r))if(t.includes(o))return i;return t.replace("카드","").substring(0,2).toUpperCase()},Rr=t=>{const e=t.toUpperCase(),n=[{keywords:["BC","BC카드","비씨"],svg:"bcCard.svg"},{keywords:["KB","국민","KB국민","케이비"],svg:"kbCard.svg"},{keywords:["NH","농협","NH농협"],svg:"nhCard.svg"},{keywords:["삼성","SAMSUNG","삼성카드","SAMSUNG CARD"],svg:"samsungCard.svg"},{keywords:["현대","HYUNDAI","현대카드"],svg:"hyundaiCard.svg"},{keywords:["신한","SHINHAN","신한카드"],svg:"shinhanCard.svg"},{keywords:["롯데","LOTTE","롯데카드"],svg:"lotteCard.svg"},{keywords:["하나","HANA","하나카드","SK"],svg:"hanaCard.svg"},{keywords:["우리","WOORI","우리카드"],svg:"wooriCard.svg"},{keywords:["씨티","CITI","씨티카드","CITIBANK"],svg:"citiCard.svg"},{keywords:["VISA","비자"],svg:"visaCard.svg"},{keywords:["MASTER","마스터","MASTERCARD"],svg:"masterCard.svg"},{keywords:["AMEX","아멕스","AMERICAN EXPRESS"],svg:"amexCard.svg"}];for(const{keywords:r,svg:o}of n)for(const i of r)if(e.includes(i.toUpperCase()))try{return chrome?.runtime?.getURL(`assets/card/${o}`)??null}catch{return null}return null},Dr=(t,e,n)=>{const r=" recommended",o=document.createElement("div");o.className=`picsel-card-benefit-item${r}`;const i=t.cardName||t.card||"카드",s=Rr(i)||t.imageUrl;if(s){const x=document.createElement("div");x.className="picsel-card-image-wrapper";const _=document.createElement("img");_.src=s,_.alt=i,_.className="picsel-card-image",_.onerror=()=>{const C=an(i);x.textContent="";const w=document.createElement("div");w.className="picsel-card-initial",w.textContent=Tt.sanitize(C,{ALLOWED_TAGS:[]}),x.appendChild(w)},x.appendChild(_),o.appendChild(x)}else{const x=an(i),_=document.createElement("div");_.className="picsel-card-image-wrapper";const C=document.createElement("div");C.className="picsel-card-initial",C.textContent=Tt.sanitize(x,{ALLOWED_TAGS:[]}),_.appendChild(C),o.appendChild(_)}const l=document.createElement("div");l.className="picsel-card-info";const u=document.createElement("div");if(u.className="picsel-card-header",(t.discountAmount??0)>0){const x=document.createElement("span");x.className="picsel-recommended-badge",x.textContent=`${e+1}위`,u.appendChild(x)}const m=document.createElement("span");m.className="picsel-card-name";const p=i.includes(",")?i.split(",")[0].trim():i;if(m.textContent=p,u.appendChild(m),l.appendChild(u),t.benefit){const x=document.createElement("div");x.className="picsel-card-benefit-desc",x.textContent=t.benefit,l.appendChild(x)}o.appendChild(l);const b=document.createElement("div");if(b.className="picsel-card-amount",t.benefitType==="installment"){const x=document.createElement("div");x.className="picsel-card-installment",x.textContent=t.benefit||"무이자",b.appendChild(x)}else if(typeof t.discountAmount=="number"&&t.discountAmount>0){if(typeof t.finalPrice=="number"){const C=document.createElement("div");C.className="picsel-card-final-price";const w=fe(t.finalPrice,n);C.textContent=w,b.appendChild(C)}const x=document.createElement("div");x.className="picsel-card-discount";const _=fe(t.discountAmount,n);x.textContent=`-${_}`,b.appendChild(x)}else if(typeof t.rate=="number"&&t.rate>0){const x=document.createElement("div");x.className="picsel-card-rate",x.textContent=`${t.rate}%`,b.appendChild(x)}return o.appendChild(b),o},Lr=t=>{const e=Array.isArray(t.cardBenefits)?t.cardBenefits:[];if(e.length===0){const g=document.createElement("section");g.className="picsel-section picsel-card-section picsel-hidden",g.setAttribute("data-empty","true"),g.style.display="none";const x=document.createElement("h4");x.className="picsel-section-title",x.textContent="카드별 혜택",g.appendChild(x);const _=document.createElement("div");return _.className="picsel-empty-benefits",_.textContent="이 상품에는 카드 혜택이 없어요",g.appendChild(_),g}const n=typeof t.discountPrice=="number"&&t.discountPrice>0?t.discountPrice:t.amount,i=e.map(g=>{const x=g;if(x.benefitType==="point"||x.benefitType==="installment")return null;const _=x.rate??x.discount;let C=0,w=0;typeof _=="number"&&_>100||x.benefitType==="discount"?(C=typeof _=="number"&&_>100?_:x.discount??0,w=0):(w=typeof _=="number"&&_<=100?_:0,C=kr(n,w)??0);const L=Ir(n,C);return{...x,cardName:x.cardName??x.card,rate:w,discountAmount:C??void 0,finalPrice:L??void 0}}).filter(g=>g!==null).sort((g,x)=>{const _=g?.discountAmount??0,C=x?.discountAmount??0;if(_!==C)return C-_;const w=g?.rate??0;return(x?.rate??0)-w})[0];if(!i)return null;const c=document.createElement("section");c.className="picsel-section picsel-card-section";const s=document.createElement("h4");s.className="picsel-section-title",s.textContent="추천 카드 혜택",c.appendChild(s);const l=document.createElement("div");l.className="picsel-card-benefit-list";const u=t.currency??"KRW",m=Dr(i,0,u);l.appendChild(m),c.appendChild(l);const p=[],b=t.elevenst?.totalPointAmount??0;if(b>0&&p.push(`최대 적립 포인트 ${b.toLocaleString()}P`),t.giftCardDiscount?.description&&p.push(t.giftCardDiscount.description),t.cashback?.description&&p.push(t.cashback.description),p.length>0){const g=document.createElement("div");g.className="picsel-sub-benefits",p.forEach(x=>{const _=document.createElement("div");_.className="picsel-sub-benefit-item";const C=x.match(/(\d{1,3}(,\d{3})*)/);if(C){const w=x.substring(0,C.index),L=C[0],q=x.substring((C.index??0)+L.length);_.innerHTML=Tt.sanitize(`${w}<strong style="color: #1d4ed8; font-weight: 700;">${L}</strong>${q}`,{ALLOWED_TAGS:["strong"],ALLOWED_ATTR:["style"]})}else _.textContent=x;g.appendChild(_)}),c.appendChild(g)}return c},Mr=t=>{const e=document.createElement("footer");e.className="picsel-footer";const n=document.createElement("div");n.className="picsel-footer-buttons";const r=document.createElement("button");return r.className="picsel-footer-confirm",r.textContent="확인했습니다",r.type="button",r.addEventListener("click",()=>{Ce(!1)}),n.appendChild(r),e.appendChild(n),e},Or=(t,e)=>fe(t,e??"KRW")??`${t.toLocaleString()}원`,Br=t=>fe(t,"KRW")??`${t.toLocaleString()}원`,Ur=t=>Array.isArray(t.top_prices)&&t.top_prices.length>0?t.top_prices.map(n=>({provider:n.mall||"Unknown",name:n.mall||"Unknown",price:n.price,currency:"KRW",url:n.link,free_shipping:n.free_shipping,delivery:n.delivery})).filter(n=>typeof n.price=="number"&&n.price>0).slice(0,3):(Array.isArray(t.results)?t.results:[]).filter(n=>n&&n.success&&Array.isArray(n.products)).flatMap(n=>n.products.map(r=>({provider:n.provider,name:r.name,price:r.price,currency:r.currency,url:r.url}))).filter(n=>typeof n.price=="number"&&n.price>0).sort((n,r)=>n.price-r.price).slice(0,3),ln='<svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13.333 4L6.667 11.333 3.333 8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',zr=t=>{const{panelIsOpen:e,comparison:n}=t,r=document.createElement("section");if(r.className="picsel-section picsel-lowest-price-section",!e){const g=document.createElement("div");return g.className="picsel-empty-state",g.textContent="패널을 열면 최저가 비교를 시작합니다.",r.appendChild(g),r}if(n.status==="loading"){const g=document.createElement("div");return g.className="picsel-empty-state",g.textContent="가격 비교 중...",r.appendChild(g),r}if(n.status==="error"){const g=document.createElement("div");return g.className="picsel-empty-state",g.textContent=n.error||"가격 비교 중 오류가 발생했습니다.",r.appendChild(g),r}if(n.status!=="success"||!n.data){const g=document.createElement("div");return g.className="picsel-empty-state",g.textContent="상품명을 찾을 수 없어 가격 비교를 실행할 수 없습니다.",r.appendChild(g),r}const o=n.data,i=Ur(o),c=i.length>0?i[0].price:null,s=typeof o.current_price=="number"?o.current_price:null,l=c&&s&&s>c?s-c:null;if(l&&l>0){const g=document.createElement("div");g.className="picsel-savings-banner";const x=document.createElement("span");x.className="picsel-savings-icon",x.innerHTML=ln;const _=document.createElement("span");_.className="picsel-savings-text",_.textContent=`지금 ${Br(l)} 더 아낄 수 있어요!`,g.appendChild(x),g.appendChild(_),r.appendChild(g)}else if(c&&s&&s<=c){const g=document.createElement("div");g.className="picsel-no-savings-banner";const x=document.createElement("span");x.className="picsel-savings-icon",x.innerHTML=ln;const _=document.createElement("span");_.className="picsel-savings-text",_.textContent="현재 가격이 가장 저렴합니다.",g.appendChild(x),g.appendChild(_),r.appendChild(g)}if(i.length===0){const g=document.createElement("div");return g.className="picsel-empty-state",g.textContent="검색 결과가 없습니다.",r.appendChild(g),r}const u=document.createElement("div");u.className="picsel-section-header";const m=document.createElement("span");m.className="picsel-section-title",m.textContent="최저가 추천";const p=document.createElement("span");p.className="picsel-section-note",p.textContent="배송비 포함 기준",u.appendChild(m),u.appendChild(p),r.appendChild(u);const b=document.createElement("div");if(b.className="picsel-price-list",i.forEach((g,x)=>{const _=x===0,C=document.createElement("a");C.href=g.url||"#",C.target="_blank",C.rel="noreferrer",C.className=_?"picsel-price-item picsel-price-item-top":"picsel-price-item";const w=document.createElement("div");w.className="picsel-price-item-left";const L=document.createElement("div");L.className="picsel-mall-row";const q=document.createElement("span");if(q.className="picsel-mall-name",q.textContent=(g.name||g.provider||"알 수 없음").trim(),L.appendChild(q),_){const le=document.createElement("span");le.className="picsel-lowest-badge",le.textContent="최저가",L.appendChild(le)}w.appendChild(L);const A=document.createElement("div");A.className="picsel-price-item-right";const Y=document.createElement("span");Y.className="picsel-price-value",Y.textContent=Or(g.price,g.currency);const K=document.createElement("span");K.className="picsel-price-arrow",K.innerHTML='<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M6 4l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',A.appendChild(Y),A.appendChild(K),C.appendChild(w),C.appendChild(A),b.appendChild(C)}),r.appendChild(b),o.link){const g=document.createElement("a");g.href=o.link,g.target="_blank",g.rel="noreferrer",g.className="picsel-footer-link",g.innerHTML='<svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M5 2h7m0 0v7m0-7L5 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg> 정확한 정보 확인하기',r.appendChild(g)}return r},Et=t=>{const{buttonBadgeEl:e}=f;if(!e)return;if(!t){e.style.display="none";return}const n=Array.isArray(t.cardBenefits)?t.cardBenefits.map(o=>{const i=o,c=i.rate??i.discount;return typeof c=="number"?c:0}).filter(o=>o>0):[];if(n.length>0){const o=Math.max(...n);e.textContent=`최대 ${o}%`,e.style.display="inline-flex";return}const r=t.cashback?.amount;if(typeof r=="number"&&r>0){const o=fe(r,t.currency??"KRW");e.textContent=o?`${o} 적립`:"캐시백 혜택",e.style.display="inline-flex";return}e.style.display="none"},X=()=>{const{contentEl:t,cachedData:e}=f;if(!t)return;if(t.textContent="",!e){const c=document.createElement("p");c.className="picsel-empty-state",c.textContent="상품 정보를 불러오는 중입니다.",t.appendChild(c),Et(null);return}const n=e,{displayMode:r}=ae.getState();if(t.appendChild(ar(n)),r==="lowest-price"){const c=!!f.panelEl?.classList.contains("open");t.appendChild(zr({panelIsOpen:c,comparison:f.comparison})),Et(null);return}const o=Lr(n);o&&t.appendChild(o);const i=Mr();i&&t.appendChild(i),Et(n)},Fr=async(t,e)=>{if(t&&f.comparison.status!=="loading"&&!(f.comparison.query===t&&(f.comparison.status==="success"||f.comparison.status==="error"))){f.comparison={status:"loading",query:t,error:null,data:null};try{if(!chrome?.runtime?.sendMessage){f.comparison={status:"error",query:t,error:"Chrome extension API를 사용할 수 없습니다.",data:null},e?.();return}const n=await chrome.runtime.sendMessage({type:"CHECK_COMPARISON_SERVER"});if(!n?.success){f.comparison={status:"error",query:t,error:n?.error||"가격 비교 서버가 실행 중이 아닙니다.",data:null},e?.();return}const r=await chrome.runtime.sendMessage({type:"COMPARE_PRICES",query:t});if(r?.success){f.comparison={status:"success",query:t,error:null,data:{...r.data,current_price:f.cachedData?.amount}},e?.();return}f.comparison={status:"error",query:t,error:r?.error||"가격 비교 검색 실패",data:null},e?.()}catch(n){f.comparison={status:"error",query:t,error:n instanceof Error?n.message:"알 수 없는 오류",data:null},e?.()}}},En=(t,e,n)=>{if(t&&f.comparison.status!=="loading"){if(f.comparison.query===t&&(f.comparison.status==="success"||f.comparison.status==="error")){n?.();return}f.comparison={status:"loading",query:t,error:null,data:null},e(),Fr(t,n).finally(()=>{e()})}},un=["잠깐만요, 확인 중","지금 찾고 있어요","곧 보여드릴게요","조금만 기다려요","계산 중이에요","정리하고 있어요","비교하는 중이에요","거의 다 됐어요","지금 처리 중","금방 끝나요","찾는 중이에요","잠시만요"];let je=0;const _n=()=>{const t=un[je];return je=(je+1)%un.length,t},qr=()=>{je=0};let _e=null;const Cn=()=>{const{toggleButton:t,buttonLabelEl:e}=f;if(!t||!e)return;const{displayMode:n}=ae.getState();if(n==="card-benefits"){e.textContent!=="PicSel 혜택 보기"&&(e.textContent="PicSel 혜택 보기");return}if(e.textContent==="PicSel 혜택 보기"){e.innerHTML="";const r=document.createElement("div");r.className="picsel-loading-message",r.setAttribute("data-loading-message","true"),r.style.display="flex",r.style.alignItems="center",r.style.gap="8px";const o=document.createElement("div");o.className="picsel-loading-spinner";const i=document.createElement("span");i.className="picsel-loading-text",i.textContent=_n(),r.appendChild(o),r.appendChild(i),e.appendChild(r),$r(i)}},$r=t=>{_e&&clearInterval(_e),_e=setInterval(()=>{t.textContent=_n()},2e3)},Wr=()=>{_e&&(clearInterval(_e),_e=null),qr()},Ce=t=>{const{panelEl:e,toggleButton:n,buttonLabelEl:r}=f;if(!(!e||!n||!r)){if(t){e.classList.add("open"),e.setAttribute("aria-hidden","false"),n.setAttribute("aria-expanded","true"),r.textContent="PicSel 혜택 닫기";const{displayMode:o}=ae.getState();o==="lowest-price"&&f.cachedData?.title?En(f.cachedData.title,X):X();return}e.classList.remove("open"),e.setAttribute("aria-hidden","true"),n.setAttribute("aria-expanded","false"),r.textContent="PicSel 혜택 보기",Cn()}},Hr=`
		:host {
			all: initial;
			position: fixed;
