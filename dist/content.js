...
`,O=(t,e="KRW")=>{if(typeof t!="number"||!Number.isFinite(t))return null;const n=e||"KRW",r=new Set(["KRW","JPY"]),o={style:"currency",currency:n};let i=t;r.has(n)&&(o.minimumFractionDigits=0,o.maximumFractionDigits=0,i=Math.round(t));const a=n==="KRW"?"ko-KR":"en-US";return new Intl.NumberFormat(a,o).format(i)},Ce=(t,e)=>typeof t!="number"||typeof e!="number"||t<=0||e>=t?null:Math.round((t-e)/t*100),U="picsel-toggle-host",W="picsel-toggle-panel";let b=null,C=null,f=null,N=null,y=null,l=null,k=null,E=null,q=!1,D=null;const ye=()=>{if(q)return;if(document.getElementById(U)){const o=document.getElementById(U);o&&(b=o,C=o.shadowRoot,C&&(f=C.querySelector(".picsel-toggle-button"),N=C.querySelector(".picsel-toggle-label"),y=C.querySelector(".picsel-toggle-badge"),l=C.querySelector(`#${W}`),k=C.querySelector(".picsel-close-button"),E=C.querySelector(".picsel-panel-content"))),q=!0;return}b=document.createElement("div"),b.id=U,b.style.position="fixed",b.style.bottom="24px",b.style.right="24px",b.style.zIndex=String(2147483647),C=b.attachShadow({mode:"open"});const t=document.createElement("style");t.textContent=be,C.appendChild(t);const e=document.createElement("div");e.className="picsel-toggle-container",C.appendChild(e),f=document.createElement("button"),f.className="picsel-toggle-button",f.type="button",f.setAttribute("aria-expanded","false"),N=document.createElement("span"),N.className="picsel-toggle-label",N.textContent="PicSel 혜택 보기",f.appendChild(N),y=document.createElement("span"),y.className="picsel-toggle-badge",f.appendChild(y),e.appendChild(f),l=document.createElement("div"),l.className="picsel-panel",l.id=W,l.setAttribute("role","dialog"),l.setAttribute("aria-hidden","true"),f.setAttribute("aria-controls",W);const n=document.createElement("div");n.className="picsel-panel-header";const r=document.createElement("div");r.className="picsel-panel-title",r.textContent="PicSel 혜택 정보",k=document.createElement("button"),k.type="button",k.className="picsel-close-button",k.setAttribute("aria-label","닫기"),k.textContent="✕",n.appendChild(r),n.appendChild(k),l.appendChild(n),E=document.createElement("div"),E.className="picsel-panel-content",l.appendChild(E),e.appendChild(l),f.addEventListener("click",()=>{const o=!(l!=null&&l.classList.contains("open"));$(o)}),k.addEventListener("click",()=>{$(!1)}),window.addEventListener("keydown",o=>{o.key==="Escape"&&$(!1)}),document.addEventListener("click",o=>{if(!(l!=null&&l.classList.contains("open")))return;const i=o.composedPath();b&&!i.includes(b)&&$(!1)},!0),document.body.appendChild(b),q=!0},$=t=>{!l||!f||!N||(t?(l.classList.add("open"),l.setAttribute("aria-hidden","false"),f.setAttribute("aria-expanded","true"),N.textContent="PicSel 혜택 닫기"):(l.classList.remove("open"),l.setAttribute("aria-hidden","true"),f.setAttribute("aria-expanded","false"),N.textContent="PicSel 혜택 보기"))},L=t=>{var r;if(!y)return;if(!t){y.style.display="none";return}const e=Array.isArray(t.cardBenefits)?t.cardBenefits.map(o=>typeof(o==null?void 0:o.rate)=="number"?o.rate:0).filter(o=>o>0):[];if(e.length>0){const o=Math.max(...e);y.textContent=`최대 ${o}%`,y.style.display="inline-flex";return}const n=(r=t.cashback)==null?void 0:r.amount;if(typeof n=="number"&&n>0){const o=O(n,t.currency??"KRW");y.textContent=o?`${o} 적립`:"캐시백 혜택",y.style.display="inline-flex";return}y.style.display="none"},Y=()=>{var B,z;if(!E)return;if(E.textContent="",!D){const s=document.createElement("p");s.className="picsel-empty-state",s.textContent="상품 정보를 불러오는 중입니다.",E.appendChild(s),L(null);return}const t=D,e=document.createElement("div");e.className="picsel-product";const n=document.createElement("div");n.className="picsel-product-thumb";const r=t.imageUrl||Array.isArray(t.images)&&t.images[0]||null;if(r){const s=document.createElement("img");s.src=r,s.alt=t.title?`${t.title} 이미지`:"상품 이미지",n.appendChild(s)}else{const s=document.createElement("span");s.textContent="No Image",s.style.fontSize="11px",s.style.color="#64748b",n.appendChild(s)}const o=document.createElement("div");o.className="picsel-product-info";const i=document.createElement("h3");i.className="picsel-product-title",i.textContent=t.title||"상품 정보를 찾을 수 없어요.";const a=document.createElement("div");a.className="picsel-price";const c=typeof t.discountPrice=="number"&&t.discountPrice>0?t.discountPrice:t.amount,m=O(c,t.currency??"KRW");if(m){const s=document.createElement("div");s.className="picsel-final-price",s.textContent=m,a.appendChild(s)}const g=O(t.originalPrice,t.currency??"KRW"),w=Ce(t.originalPrice,c);if(g&&w){const s=document.createElement("div");s.className="picsel-original-price",s.textContent=g;const u=document.createElement("div");u.className="picsel-discount-tag",u.textContent=`-${w}%`,a.appendChild(s),a.appendChild(u)}if(o.appendChild(i),o.appendChild(a),t.shippingInfo){const s=document.createElement("div");s.className="picsel-shipping",s.textContent=`배송: ${t.shippingInfo}`,o.appendChild(s)}e.appendChild(n),e.appendChild(o),E.appendChild(e);const h=Array.isArray(t.cardBenefits)?t.cardBenefits.slice(0,3):[];if(h.length>0){const s=document.createElement("section");s.className="picsel-section";const u=document.createElement("h4");u.className="picsel-section-title",u.textContent="카드 혜택 TOP",s.appendChild(u);const x=document.createElement("div");x.className="picsel-benefit-list",h.forEach(v=>{const p=document.createElement("div");p.className="picsel-benefit-item";const T=document.createElement("div");if(T.className="picsel-card-name",T.textContent=v.cardName||"제휴 카드",p.appendChild(T),v.benefit){const I=document.createElement("div");I.className="picsel-benefit-desc",I.textContent=v.benefit,p.appendChild(I)}x.appendChild(p)}),s.appendChild(x),E.appendChild(s)}const d=[];if((B=t.giftCardDiscount)!=null&&B.description&&d.push(`🎁 ${t.giftCardDiscount.description}`),(z=t.cashback)!=null&&z.description&&d.push(`💰 ${t.cashback.description}`),d.length>0){const s=document.createElement("section");s.className="picsel-section";const u=document.createElement("h4");u.className="picsel-section-title",u.textContent="추가 혜택",s.appendChild(u);const x=document.createElement("div");x.className="picsel-extra-list",d.forEach(v=>{const p=document.createElement("div");p.className="picsel-extra-item",p.textContent=v,x.appendChild(p)}),s.appendChild(x),E.appendChild(s)}const P=Array.isArray(t.variants)?t.variants.slice(0,3):[];if(P.length>0){const s=document.createElement("section");s.className="picsel-section";const u=document.createElement("h4");u.className="picsel-section-title",u.textContent="다른 구성",s.appendChild(u);const x=document.createElement("div");x.className="picsel-variants",P.forEach(v=>{const p=document.createElement("div");p.className="picsel-variant-item";const T=document.createElement("div");T.className="picsel-variant-name",T.textContent=v.name||"옵션";const I=document.createElement("div");I.className="picsel-variant-price";const Z=O(v.price,t.currency??"KRW");if(I.textContent=Z||"-",p.appendChild(T),p.appendChild(I),v.discount){const F=document.createElement("div");F.className="picsel-variant-discount",F.textContent=v.discount,p.appendChild(F)}x.appendChild(p)}),s.appendChild(x),E.appendChild(s)}L(t)},G=t=>{D={...t},ye(),Y(),$(!1)},J=t=>{if(D={...D??{},...t},!q){G(D);return}Y()};if(window.self!==window.top){const t=window.location.href,e=window.location.hostname,n=window.location.pathname;console.debug("[ContentScript:iframe] 📍 Iframe detected",{context:"iframe",url:t,host:e,pathname:n,selfIsTop:window.self===window.top})}console.log("[ContentScript] ✅ Content script initialized in main frame");function Ee(){const t=window.location.href;return j.isCheckoutPage(t)?{site:"coupang",isCheckout:!0}:V.isCheckoutPage(t)?{site:"amazon",isCheckout:!0}:H.isCheckoutPage(t)?{site:"ebay",isCheckout:!0}:{site:"unknown",isCheckout:!1}}function we(t){switch(t){case"coupang":return new j;case"amazon":return new V;case"ebay":return new H;default:return null}}function X(){const{site:t,isCheckout:e}=Ee();if(!e)return console.log("[ContentScript] Not a checkout page"),null;console.log(`[ContentScript] Checkout detected: ${t}`);const n=we(t);if(n){const o=n.parse(document);if(o)return o}return console.log("[ContentScript] Trying fallback..."),new xe().parse(document)}function Pe(t){chrome.runtime.sendMessage({type:"SAVE_PRODUCT_DATA",data:t,url:window.location.href,timestamp:Date.now()},e=>{var n,r;e!=null&&e.success?(console.log("[ContentScript] ✅ Data saved",{responseSuccess:e.success,savedAmount:(n=e.savedData)==null?void 0:n.amount,savedCurrency:(r=e.savedData)==null?void 0:r.currency}),J(t)):console.error("[ContentScript] ❌ Background error:",{error:e==null?void 0:e.error,message:e==null?void 0:e.message})})}function K(){if(console.log("[ContentScript] Initializing..."),window.self!==window.top){console.debug("[ContentScript] Skipping - running in iframe context");return}const t=X();if(!t){console.warn("[ContentScript] Failed to extract");return}console.log("[ContentScript] Extracted data:",t),G(t),console.log("[ContentScript] Sending to background..."),Pe(t)}function _(){const t=new MutationObserver(e=>{e.some(r=>r.addedNodes.length>0&&Array.from(r.addedNodes).some(o=>o.tagName==="IFRAME"||o instanceof Element&&o.querySelector("iframe")))&&(console.log("[ContentScript] 🔄 New iframe detected, re-parsing dynamic content..."),setTimeout(()=>{const r=X();r&&(console.log("[ContentScript] ✅ Dynamic content re-parsed:",r),J(r),chrome.runtime.sendMessage({type:"UPDATE_PRODUCT_DATA",data:r,timestamp:Date.now(),source:"dynamic-iframe"},o=>{o!=null&&o.success&&console.log("[ContentScript] ✅ Dynamic data updated in storage")}))},500),t.disconnect())});t.observe(document.body,{childList:!0,subtree:!0,attributes:!1}),console.log("[ContentScript] 📡 Dynamic content observer started")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{K(),_()}):(K(),_());
